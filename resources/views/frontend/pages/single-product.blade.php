...
@include('frontend.layout.inc.breadcumb', ['pagename'=>$product->product_name])
                ...
                <div class="product-single-img">
                    <div class="product-active owl-carousel">
                        ...
                        @foreach ($product->productImages as $image)
                            <div class="item">
                                <img src="{{ asset('uploads/products') }}/{{ $image->image_name }}" alt="">
                            </div>
                        @endforeach
                    </div>
            ...
            <div class="col-lg-3 col-sm-6 col-12">
                <div class="featured-product-wrap">
                    <div class="featured-product-img">
                        <img src="{{ asset('uploads/products') }}/{{ $rproduct->product_image }}" alt="">
                    </div>
                    <div class="featured-product-content">
                        <div class="row">
                            <div class="col-7">
                                <h3><a href="{{ route('productdetail.page', ['product_slug'=>$rproduct->slug ]) }}">{{ $rproduct->product_name }}</a></h3>
                                <p>${{ $rproduct->product_price }}</p>
                            </div>
